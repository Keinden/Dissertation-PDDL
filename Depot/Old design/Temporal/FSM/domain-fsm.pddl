...
(:predicates
    ...
    ; FSM state related
    (idle ?agt - agent)
    (dock_state ?agt - agent)
    (transport_state ?agt - agent)
    (distribution_state ?agt - agent)
)
...
(:durative-action idle-to-transportation
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
...
(:durative-action transportation-to-idle
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
...
(:durative-action idle-to-distribution
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
...
(:durative-action distribution-to-idle
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
