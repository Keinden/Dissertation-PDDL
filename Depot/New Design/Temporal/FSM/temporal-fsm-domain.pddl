...
(:predicates
    ...
    ; Agent States
    (idle ?agt - agent)
    (dock-state ?agt - agent)
    (transport-state ?agt - agent)
)
...
(:durative-action idle-state-to-transport-state 
...
(:durative-action idle-state-to-dock-state
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
...
(:durative-action dock-state-to-idle-state
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
...
(:durative-action transportation-state-to-idle-state
    :parameters (?agt - agent)
    :duration (= ?duration 1)
    :condition (and 
        (at start (and 
